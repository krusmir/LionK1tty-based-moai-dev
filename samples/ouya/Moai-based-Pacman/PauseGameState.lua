...
function PauseGameState:enter()
    ...
    MOAIOuyaAndroid.setListener ( MOAIOuyaAndroid.OUYA_BUTTON_DOWN,  PauseGameState.onOuyaButtonDownEvent )
...
function PauseGameState.onOuyaButtonDownEvent(keycode,player)
    if ( PAUSE_GAME_STATE == nil )
    then
        return
    end
